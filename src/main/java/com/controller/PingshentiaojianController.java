...
public class PingshentiaojianController {
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<PingshentiaojianEntity> wrapper = new EntityWrapper<PingshentiaojianEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = pingshentiaojianService.selectCount(wrapper);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,PingshentiaojianEntity pingshentiaojian, HttpServletRequest request,String pre){
        EntityWrapper<PingshentiaojianEntity> ew = new EntityWrapper<PingshentiaojianEntity>();
